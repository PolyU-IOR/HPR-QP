...
function update_y_QAP_kernel!(dy::CuDeviceVector{Float64},
...
function update_w2_QAP_kernel!(dw::CuDeviceVector{Float64},
...
function update_w2_kernel!(dw::CuDeviceVector{Float64}, ATdy::CuDeviceVector{Float64},
...
function update_w2_gpu!(ws::HPRQP_workspace_gpu, Halpern_fact1::Float64, Halpern_fact2::Float64)
    CUDA.CUSPARSE.mv!('N', 1, ws.AT, ws.y_bar, 0, ws.ATy_bar, 'O', CUDA.CUSPARSE.CUSPARSE_SPMV_CSR_ALG2)
    @cuda threads = 256 blocks = ceil(Int, ws.n / 256) update_w2_kernel!(ws.dw, ws.ATdy, ws.w, ws.w_bar, ws.last_w, ws.last_ATy, ws.ATy, ws.ATy_bar, ws.sigma / (1.0 + ws.sigma * ws.lambda_max_Q), Halpern_fact1, Halpern_fact2, ws.n)
end
...
# Customized version (inline SpMV for small problems)
...
function update_w2_diagQ_kernel!(dw::CuDeviceVector{Float64}, ATdy::CuDeviceVector{Float64},
...
function update_w2_diagQ_gpu!(ws::HPRQP_workspace_gpu, Halpern_fact1::Float64, Halpern_fact2::Float64)
    CUDA.CUSPARSE.mv!('N', 1, ws.AT, ws.y_bar, 0, ws.ATy_bar, 'O', CUDA.CUSPARSE.CUSPARSE_SPMV_CSR_ALG2)
    @cuda threads = 256 blocks = ceil(Int, ws.n / 256) update_w2_diagQ_kernel!(ws.dw, ws.ATdy, ws.w, ws.w_bar, ws.last_w, ws.last_ATy, ws.ATy, ws.ATy_bar, ws.fact, Halpern_fact1, Halpern_fact2, ws.n)
end
