...
This guide explains how to interpret the results returned by HPRQP solvers and understand the termination status.

## Result Fields Summary

All HPRQP solving functions return an `HPRQP_results` object with the following fields:
...
HPRQP tracks when certain accuracy levels are reached:
